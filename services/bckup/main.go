...
func main() {
	...
	uppercaseHandler := httptransport.NewServer(
		gokitjwt.NewParser(keys, jwt.SigningMethodHS256, claimsFactory)(makeUppercaseEndpoint(svc)),
	...
	countHandler := httptransport.NewServer(
		gokitjwt.NewParser(keys, jwt.SigningMethodHS256, claimsFactory)(makeCountEndpoint(svc)),
		decodeCountRequest,
		encodeResponse,
		jwtOptions...,
	)
