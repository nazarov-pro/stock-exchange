...
// emailRepository represents PostgreSql repository
...
func New(db *sql.DB, logger log.Logger) domain.EmailRepository {
...
func (repo *emailRepository) Insert(ctx context.Context, msg *domain.EmailMessage) error {
